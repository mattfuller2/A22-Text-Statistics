...
public interface TextStatisticsInterface {
	...
	/**
	 * @return the wordLengthCount array with locations [0]..[23] with location [i] storing the
	 *         number of words of length i in the text file. Location [0] is not used. Location [23]
	 *         holds the count of words of length 23 and higher.
	 */
